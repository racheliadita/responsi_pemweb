<?php
 ...
 if (isset($_GET['edit']))
 {
  $SQL = $dbconnect->query ("SELECT * FROM ipa WHERE id=".$_GET['edit']);
  $getRow = $SQL ->fetch_array();
 }
 if(isset($_POST['update']))
{
  $SQL = $dbconnect->prepare("UPDATE ipa SET nis=?, nama=?, kelas=?, nilai=? WHERE id=?");
...
<body>
      ...
      <div class="head">
        <h1><b>Edit Nilai Mata Pelajaran IPA<b></h1>
      </div>
