...
<div class="head">
        <h1><b>Nilai Mata Pelajaran Bahasa Inggris<b></h1>
</div>
...
<form class="form" action = "" method = "POST">
	<table align = "center" cellspacing = "0" cellpadding = "5" border="0px">
		<tr>
			...
			<td colspan="4"><button formaction="../bahasa_inggris/tambah.php">Tambah Data</button></td>
		</tr>
		<tr>
			<td colspan="4"> </td>
			<td colspan="4"> </td>
...
<?php
	include 'config.php';
	$view = $dbconnect -> query ("SELECT * FROM inggris");
